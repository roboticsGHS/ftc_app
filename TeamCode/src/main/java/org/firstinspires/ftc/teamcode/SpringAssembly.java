    ...
    public void loop() {
      ...
      /*
        ...
        */
        ...
        //float lift_pos = gamepad1.left_trigger;
        //float lift_neg = -gamepad1.right_trigger;
...
//    }
    ...
    /*    servo.setPosition(servoPosition);
        ...
        servo3.setPosition(servoPosition3);
        servoPosition3  = Range.clip(servoPosition3, 0, 1);
        */
        if (gamepad1.b)
